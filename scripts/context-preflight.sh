...

{
  ...
  printf "%s\n" "## 目标"
  printf "%s\n" "- 线程角色：asset-governance / implementation / release-ops / research-archive / external-monitor"
  printf "%s\n" "- 目标强度：weak / strong / continuous"
  printf "%s\n" "- 本轮目标："
  printf "%s\n" "- 范围："
  printf "%s\n" "- 非目标："
  printf "%s\n" "- 成功标准："
